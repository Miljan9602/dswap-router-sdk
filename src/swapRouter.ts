...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from '@miljan9602/dswap-sdk-core'
import { abi } from '@dragonswap/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from '@miljan9602/dswap-v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
